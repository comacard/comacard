...
interface IASCRelayingQuoter {
    ...
    function priceUpdate(uint64 newSourcePrice, uint16 chainId, PricingData calldata price) external;
    ...
    function setAcknowledgmentFee(uint16 dstChain, uint256 newAcknowledgmentFeeInAttest) external;
