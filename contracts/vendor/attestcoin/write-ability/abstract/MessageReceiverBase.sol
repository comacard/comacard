...
abstract contract MessageReceiverBase is IMessageReceiver, Ownable2Step {
    ...
    constructor(address initialInbox, address initialOwner) Ownable(initialOwner) {
    ...
    function setTrustedInbox(address inbox, bool trusted) external virtual override onlyOwner {
    ...
    function isTrustedInbox(address inbox) external view virtual override returns (bool) {
