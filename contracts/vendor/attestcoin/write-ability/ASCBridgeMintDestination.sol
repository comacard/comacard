...
contract ASCBridgeMintDestination is Ownable2Step {
    ...
    constructor(address initialBridgeOperator, address initialMintToken, address initialOwner)
        Ownable(initialOwner)
    {
        if (
            initialBridgeOperator == address(0) || initialMintToken == address(0)
    ...
    function executeMint(bytes32 intentId, address token, address recipient, uint256 amount)
        external
    {
