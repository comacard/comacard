...
library QueryProofVerificationLib {
    ...
    function continuityDigest(uint64 blockNumber, bytes32 merkleRoot, bytes32 prevDigest)
        internal
        pure
        returns (bytes32)
    {
    ...
    function decodeBinaryMerklePayload(bytes calldata data)
        internal
        pure
    ...
    function txBytesFromInclusion(BlockProverTypes.InclusionProof calldata inclusionProof)
        internal
        pure
        returns (bytes memory txBytes)
    {
