...
export function CardFolderPanel({
  ...
  const holder = account?.card.holder ?? "";
  ...
  return (
    <div className={`flex justify-center ${className}`}>
      <CardFolder
        ...
        ariaLabel={issued ? undefined : "Your card, not issued yet"}
        cardNumber={pan}
        expiry={expiry}
        cvv={cvv}
        ...
        card={
          <CardArtwork holder={holder} number={pan} expiry={expiry} detailsVisible={revealed} />
        }
      />
    </div>
  );
